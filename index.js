...
function fetchTopStocks() {
  // Fetch data from api
  fetch(
    "https://www.alphavantage.co/query?function=SECTOR&apikey=65REDTGDVZ7OH7LC"
  )
...
function fetchStockData(symbol) {
  ...
  fetch(
    `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=65REDTGDVZ7OH7LC`
  )
    .then((response) => response.json())
    .then((data) => {
